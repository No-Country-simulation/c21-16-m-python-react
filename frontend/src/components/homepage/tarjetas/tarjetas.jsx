...
export const Tarjetas = () => {
  const datosTarjetas = [
    { img: comida, titulo: "Encuentra tus gustos" ,fondo:"#FF7A45",boton:"Ver comidas"},
    { img: personas, titulo: "Conoce personas" ,fondo:"#31B77E",boton:"Ver personas"},
    { img: social, titulo: "Comparte tus gustos" ,fondo:"rgb(58, 12, 59)",boton:"Ver publicaciones"},
  ];
  return (
